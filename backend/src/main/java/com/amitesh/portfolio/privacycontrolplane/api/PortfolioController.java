package com.amitesh.portfolio.privacycontrolplane.api;
...
public class PortfolioController {
    ...
    @GetMapping("/about")
    public Map<String, String> about() { return Map.of("product", "Privacy Control Plane", "recordType", "Privacy review"); }
